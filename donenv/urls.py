"""
URL configuration for donenv project.
...
urlpatterns = [
    ...
    path("delete-donation/<int:pid>" , views.delete_donation , name='delete_donation'),
    ...
    path("delete-volunteer/<int:pid>",views.delete_volunteer,name='delete_volunteer'),
    ...
    path("delete-area/<int:pid>", views.delete_area, name="delete_area"),
